...
@Component({
    ...
    standalone: true,
    imports: [SharedModule,NgSelectModule, LightboxModule, OverlayscrollbarsModule, ShowcodeCardComponent, FormsModule, ReactiveFormsModule, MaterialModuleModule, StockComponent, WarrantyRegistrationListComponent, InvoiceListComponent],
